...
<head>
    <!-- BASICS -->
    <meta charset="utf-8">
    <title>Crowdsourcing and recording system exploiting user activity</title>
    ...
    <!-- =======================================================
          Theme Name: Crowdsourcing system
...
<body>
    ...
    <section id="intro">
        <div class="intro-content">
            <h2>Welcome to the crowdsourcing system!!</h2>
            <h3>Crowdsourcing and recording system exploiting user activity</h3>
            <div>
